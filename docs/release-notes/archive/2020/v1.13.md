...
As an extension for [this API update](/release-notes/archive/2020/v1.6.12/#return-urls-variations), we have added a relevant block to the integration options.
